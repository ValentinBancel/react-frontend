    ...
    <div className="min-h-screen bg-gray-100 flex items-center justify-center py-10">
      <div className="bg-white p-8 rounded-lg shadow-lg max-w-3xl w-full">
        ...
        <div className="text-gray-700 space-y-6">
          ...
          <h2 className="text-2xl font-semibold text-gray-800">1. Éditeur du Site</h2>
          <p>
            Nom de l'éditeur : Sound Nation <br />
            Adresse : [Adresse de votre société] <br />
            Téléphone : [Numéro de téléphone] <br />
            Email : [Adresse email de contact]
          </p>
          
          <h2 className="text-2xl font-semibold text-gray-800">2. Hébergement du Site</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold text-gray-800">3. Propriété Intellectuelle</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold text-gray-800">4. Limitation de Responsabilité</h2>
          <p>
