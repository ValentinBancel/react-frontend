    ...
    <div className="min-h-screen bg-gray-100 flex items-center justify-center py-10">
      <div className="bg-white p-8 rounded-lg shadow-lg max-w-3xl w-full">
        ...
        <div className="text-gray-700 space-y-6">
          ...
          <h2 className="text-2xl font-semibold text-blue-600">1. Collecte des Informations</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold text-blue-600">2. Utilisation des Informations</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold text-blue-600">3. Protection des Informations</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold text-blue-600">4. Partage des Informations</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold text-blue-600">5. Vos Droits</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold text-blue-600">6. Modifications de cette Politique</h2>
          <p>
